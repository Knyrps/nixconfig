{
  ...
  wayland.windowManager.niri.settings = {
    ...
    # Repeatable top-level nodes (output, window-rule, spawn-at-startup)
    # go in _children; everything else is a plain attribute.
    _children = [
      # Left Dell (serial XGFMF5AV510L)
      {
        output = {
      ...
      # Right Dell (serial XGFMF595527L)
      {
        output = {
      ...
      # Laptop panel, right of the Dells
      {
        output = {
          _args = [ "eDP-1" ];
      ...
      # Nautilus previewer floats and takes focus
      {
        window-rule = {
    ...
    input = {
      ...
      #   scroll-button = 274;
      # };
      keyboard.numlock = { }; # xkb layout comes from localectl
      touchpad.tap = { };
    };
    ...
    screenshot-path = "~/Pictures/Screenshots/Screenshot__%Y-%m-%d_%H-%M-%S.png";
